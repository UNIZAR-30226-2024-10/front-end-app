...
final List<Tier> tiers = [
  ...
  Tier(level: 10, reward: 'chessnut', rewardType: 'pieza', requiredPoints: '100'),
  Tier(level: 11, reward: '😅️', rewardType: 'emoticono', requiredPoints: '110'),
  Tier(level: 12, reward: 'companion', rewardType: 'pieza', requiredPoints: '120'),
  Tier(level: 13, reward: '👊️', rewardType: 'emoticono', requiredPoints: '130'),
  Tier(level: 14, reward: 'fantasy', rewardType: 'pieza', requiredPoints: '140'),
  Tier(level: 15, reward: '🤩️', rewardType: 'emoticono', requiredPoints: '150'),
  Tier(level: 16, reward: 'fresca', rewardType: 'pieza', requiredPoints: '160'),
  Tier(level: 17, reward: '🤯️', rewardType: 'emoticono', requiredPoints: '170'),
  Tier(level: 18, reward: 'governor', rewardType: 'pieza', requiredPoints: '180'),
  Tier(level: 19, reward: '😜️', rewardType: 'emoticono', requiredPoints: '190'),
  Tier(level: 20, reward: 'kosal', rewardType: 'pieza', requiredPoints: '200'),
  Tier(level: 21, reward: '🫠️', rewardType: 'emoticono', requiredPoints: '210'),
  Tier(level: 22, reward: 'leipzig', rewardType: 'pieza', requiredPoints: '220'),
  Tier(level: 23, reward: '😎️', rewardType: 'emoticono', requiredPoints: '230'),
  Tier(level: 24, reward: 'mpchess', rewardType: 'pieza', requiredPoints: '240'),
  Tier(level: 25, reward: '😡️', rewardType: 'emoticono', requiredPoints: '250'),
  Tier(level: 26, reward: 'pixel', rewardType: 'pieza', requiredPoints: '260'),
  Tier(level: 27, reward: '😈️', rewardType: 'emoticono', requiredPoints: '270'),
  Tier(level: 28, reward: 'maestro', rewardType: 'pieza', requiredPoints: '280'),
  Tier(level: 29, reward: '👻️', rewardType: 'emoticono', requiredPoints: '290'),
  Tier(level: 30, reward: 'anarcandy', rewardType: 'pieza', requiredPoints: '300'),
];
