...
class _PersonalizacionState extends State<Personalizacion> {
  ...
  void _activateItem(String itemName, int id) {
    Uri url = Uri.parse(
        'https://chesshub-api-ffvrx5sara-ew.a.run.app/users/update_${itemName.length < 5 ? 'emoticonos' : 'set_piezas'}/$id');
